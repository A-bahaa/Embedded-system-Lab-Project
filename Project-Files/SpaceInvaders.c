...
int main(void){
  ...
  while(1){
			...
			ADC0_ISC_R  |= (1<<3);  // clear interrupt bit
		...
		if(vertical_pos1 > 37){
			...
			if ((horizontal_pos >= 59 && horizontal_pos <69 && r1 & (1<<0)) || (horizontal_pos >= 43 && horizontal_pos <53 && r1 & (1<<1)) 
				||(horizontal_pos >= 27 && horizontal_pos <37 && r1 & (1<<2)) || (horizontal_pos >= 11 && horizontal_pos <21 && r1 & (1<<3)) 
			  || (horizontal_pos >= 0 && horizontal_pos <10 && r1 & (1<<4))){
		...
		if ((horizontal_pos >= 59 && horizontal_pos <69 && r2 & (1<<0)) || (horizontal_pos >= 45 && horizontal_pos <53 && r2 & (1<<1))			
			||(horizontal_pos >= 27 && horizontal_pos <37 && r2 & (1<<2)) || (horizontal_pos >= 13 && horizontal_pos <21 && r2 & (1<<3)) 
			|| (horizontal_pos >= 0 && horizontal_pos <10 && r2 & (1<<4))){
					//Delay100ms(10);
					print_(score);
					break;
			}	
